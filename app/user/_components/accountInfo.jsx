  ...
  return (
    <div className='rounded-lg shadow-lg p-6'>
      ...
      <div className="grid grid-col-1 2xl:grid-cols-2 gap-4">
        <div className="flex flex-col items-center p-8 rounded-xl" style={{ backgroundColor: "#212325" }}>
          <img
        ...
        <div className="p-8 rounded-xl" style={{ backgroundColor: "#212325" }}>
          <div className="mt-2">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
            <div className="flex flex-col items-center bg-gradient-to-br from-blue-500 to-blue-700 text-white shadow rounded-lg p-4">
            ...
            <div className="flex flex-col items-center bg-gradient-to-br from-green-500 to-green-700 text-white shadow rounded-lg p-4">
            ...
            <div className="flex flex-col items-center bg-gradient-to-br from-purple-500 to-purple-700 text-white shadow rounded-lg p-4">
